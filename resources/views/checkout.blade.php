...
<head>
		...
		<title>Checkout &#8211; Magic of Memories</title>
...
<link rel="alternate" type="text/calendar" title="Wine House &raquo; iCal Feed" href="https://wine.themerex.net/events/?ical=1" />
			...
			<meta property="og:url" content="{{asset('checkout')}}" />
...
<link property="stylesheet" rel='stylesheet' id='elegro-style-css' href='https://wine.themerex.net/wp-content/plugins/elegro-payment/elegro-style.css' type='text/css' media='all' />
...
<link property="stylesheet" rel='stylesheet' id='select2-css' href='https://wine.themerex.net/wp-content/plugins/woocommerce/assets/css/select2.css?ver=7.2.2' type='text/css' media='all' />
...
<style type="text/css">.trx_demo_inline_1508849913{color:#ffffff !important;border-color:#ffaa5f !important;background-color:#ffaa5f !important;}.trx_demo_inline_526471857:hover{color:#ffffff !important;border-color:#cc884c !important;background-color:#cc884c !important;}</style>
...
<link property="stylesheet" rel='stylesheet' id='wine-house-elegro-payment-css' href='https://wine.themerex.net/wp-content/themes/wine-house/skins/default/plugins/elegro-payment/elegro-payment.css' type='text/css' media='all' />
...
<script type='text/javascript' src='https://wine.themerex.net/wp-content/plugins/elegro-payment/elegro-script.js' id='elegro-script-js'></script>
<link rel="https://api.w.org/" href="https://wine.themerex.net/wp-json/" /><link rel="alternate" type="application/json" href="https://wine.themerex.net/wp-json/wp/v2/pages/2333" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://wine.themerex.net/xmlrpc.php?rsd" />
...
<link rel="canonical" href="https://wine.themerex.net/checkout/" />
<link rel='shortlink' href='https://wine.themerex.net/?p=2333' />
<link rel="alternate" type="application/json+oembed" href="https://wine.themerex.net/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwine.themerex.net%2Fcheckout%2F" />
<link rel="alternate" type="text/xml+oembed" href="https://wine.themerex.net/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwine.themerex.net%2Fcheckout%2F&#038;format=xml" />
...
<style type="text/css" id="trx_addons-inline-styles-inline-css">.trx_addons_inline_2129148963 img.logo_image{max-height:70px;}.trx_addons_inline_1209208032{width:388px;}.trx_addons_inline_1249741438 img.logo_image{max-height:70px;}.trx_addons_inline_71647347 img.logo_image{max-height:70px;}.trx_addons_inline_1540025060 img.logo_image{max-height:70px;}.trx_addons_inline_1013236735 img.logo_image{max-height:70px;}</style></head>

<body class="page-template-default page page-id-2333 wp-custom-logo theme-wine-house hide_fixed_rows_enabled woocommerce-checkout woocommerce-page woocommerce-no-js tribe-no-js tinvwl-theme-style skin_default scheme_light blog_mode_shop body_style_wide  is_stream blog_style_excerpt sidebar_hide expand_content trx_addons_present header_type_custom header_style_header-custom-4614 header_position_default menu_side_none no_layout fixed_blocks_sticky elementor-default elementor-kit-15">
											...
											<div class="elementor-widget-wrap">
												...
												<div class="elementor-widget-container">
													...
													<div class="sc_layouts_title_content">
														...
														<h1 class="sc_layouts_title_caption">Checkout</h1>
														</div>
													</div>
													</div>
												</div>
...
{{-- <form class="woocommerce-form woocommerce-form-login login" method="post" style="display:none;">
	...
	<p class="form-row">
		...
		<input type="hidden" id="woocommerce-login-nonce" name="woocommerce-login-nonce" value="9857fd5bd7" /><input type="hidden" name="_wp_http_referer" value="/checkout/" />		<input type="hidden" name="redirect" value="https://wine.themerex.net/checkout/" />
		<button type="submit" class="woocommerce-button button woocommerce-form-login__submit wp-element-button" name="login" value="Login">Login</button>
	</p>
	<p class="lost_password">
		<a href="https://wine.themerex.net/my-account/lost-password/">Lost your password?</a>
	</p>
...
{{-- <script>
    const inclusion =  new URLSearchParams(window.location.search).get('attribute_pa_inclusions');
    const milk =  new URLSearchParams(window.location.search).get('attribute_pa_milk');
    const metal =  new URLSearchParams(window.location.search).get('attribute_pa_metal');
...
<h1>{{app('request')->input('attribute_pa_inclusions')}}</h1>
<form name="checkout" method="post" class="checkout woocommerce-checkout" action="" enctype="multipart/form-data">
            ...
            <div class="woocommerce-billing-fields">
                ...
                <div class="woocommerce-billing-fields__field-wrapper">
                    ...
                    <p class="form-row form-row-wide address-field validate-required validate-state" id="billing_state_field" data-priority="80">
                        <label for="billing_state" class="">State&nbsp; <abbr class="required" title="required">*</abbr>
                        </label>
                        <span class="woocommerce-input-wrapper">
                    ...
                    <p class="form-row form-row-wide address-field validate-required validate-postcode" id="billing_postcode_field" data-priority="90">
                        <label for="billing_postcode" class="">ZIP Code&nbsp; <abbr class="required" title="required">*</abbr>
                        </label>
                        <span class="woocommerce-input-wrapper">
    ...
    <div id="order_review" class="woocommerce-checkout-review-order">
        <div class="shop_table woocommerce-checkout-review-order-table shop_table_checkout_review">
            <table class="shop_table_in">
                <tbody>
                    <tr class="cart_item">
                        <td class="product-name"> Metal : {{app('request')->input('attribute_pa_metal')}}, Inclusion : {{app('request')->input('attribute_pa_inclusions')}}    x&nbsp;	<strong class="product-quantity">1</strong>
                        </td>
                        {{-- <td class="product-total">
                            <span class="woocommerce-Price-amount amount">
                                <bdi>
                                    <span class="woocommerce-Price-currencySymbol">&#36;</span>155.00 </bdi>
                            </span>
                        </td> --}}
                    </tr>
    ...
    <input type="text" style="display: none" class="input-text " name="inclusions" id="inclusions"  value="{{app('request')->input('attribute_pa_inclusions')}}"/>
    <input type="text" style="display: none" class="input-text " name="metal" id="metal"  value="	"/>
    <input type="text" style="display: none" class="input-text " name="breastMilk" id="breastMilk"  value="{{app('request')->input('attribute_pa_milk')}}"/>
    ...
    <button type="submit" class="button alt" name="woocommerce_checkout_place_order" id="place_order" value="Place order" data-value="Place order">Place order</button>
		...
		class="sc_layouts_logo sc_layouts_logo_default trx_addons_inline_1249741438" ><img class="logo_image"
...
<script type='text/javascript' defer="defer" src='https://wine.themerex.net/wp-content/plugins/elegro-payment/elegro-ga.js' id='elegro-ga-js'></script>
...
/* <![CDATA[ */
var TRX_DEMO_STORAGE = {"ajax_url":"https:\/\/wine.themerex.net\/wp-admin\/admin-ajax.php","ajax_nonce":"97077cd4ca","site_url":"https:\/\/wine.themerex.net","user_logged_in":"0","msg_ajax_error":"Invalid server response! Try again later.","tabs_delay":"5000"};
/* ]]> */
</script>
...
<script type='text/javascript' defer="defer" src='https://wine.themerex.net/wp-content/plugins/woocommerce/assets/js/selectWoo/selectWoo.full.min.js?ver=1.0.9-wc.7.2.2' id='selectWoo-js'></script>
...
<script type='text/javascript' defer="defer" src='https://wine.themerex.net/wp-content/plugins/woocommerce/assets/js/frontend/country-select.min.js?ver=7.2.2' id='wc-country-select-js'></script>
...
<script type='text/javascript' src='https://wine.themerex.net/wp-content/plugins/woocommerce/assets/js/frontend/address-i18n.min.js?ver=7.2.2' id='wc-address-i18n-js'></script>
<script type='text/javascript' id='wc-checkout-js-extra'>
/* <![CDATA[ */
var wc_checkout_params = {"ajax_url":"\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/?wc-ajax=%%endpoint%%","update_order_review_nonce":"d42784ef7c","apply_coupon_nonce":"ed98dd4f0b","remove_coupon_nonce":"bf0d6672cd","option_guest_checkout":"yes","checkout_url":"\/?wc-ajax=checkout","is_checkout":"1","debug_mode":"","i18n_checkout_error":"Error processing checkout. Please try again."};
/* ]]> */
</script>
<script type='text/javascript' defer="defer" src='https://wine.themerex.net/wp-content/plugins/woocommerce/assets/js/frontend/checkout.min.js?ver=7.2.2' id='wc-checkout-js'></script>
...
/* <![CDATA[ */
var wpgdprcData = {"ajaxURL":"https:\/\/wine.themerex.net\/wp-admin\/admin-ajax.php","ajaxSecurity":"c5bd3b9da6","isMultisite":"","path":"\/","blogId":""};
/* ]]> */
</script>
